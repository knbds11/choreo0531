...
const UUID = process.env.UUID || 'bff54b8a-abb5-4e3d-9f03-56e1c283070e'; //
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nezha.siginaak.cf ';     
const NEZHA_PORT = process.env.NEZHA_PORT || '443';                     //
const NEZHA_KEY = process.env.NEZHA_KEY || 'sZh4uTjJAx8ugZZh49';   //
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'chooer0629.004--dddd.tk';     //
